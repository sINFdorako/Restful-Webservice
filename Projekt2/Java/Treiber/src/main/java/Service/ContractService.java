...
public class ContractService {
    ...
    public static Contract get(int id) {
        ...
        URI uri = Service.buildURI("/config/Contract" + id);
        ...
        try {
            ...
            //Map json to object
            return new ObjectMapper().readValue(responseJSON, Contract.class);
    ...
    public static Contract create(Contract c) {
        URI uri = Service.buildURI("config/Contract");
